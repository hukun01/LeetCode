...
class Solution:
    def minMoves(self, nums: List[int], limit: int) -> int:
        ...
        number of elements that stay the same. Alternatively, we can collect
        those change points as events, and do line sweep to find the same
        answer. The advantage of the second solution is that it doesn't depend
        on the value of limit.
